import { TutorialWidget3 } from './examples/e3';
...
function Widgets({setsel}) {
    ...
    return (
        <div class="bg-[#657a85] flex flex-col items-center   w-full h-full border-4 border-t-0 border-l-0 rounded-br-md border-r-[#BF8DE1] border-b-[#BF8DE1]">
...
function AnimationControl({ args }) {
    const Elements = (() => {
        if (args != undefined && args.sel >= 0) {
            return args.comp[args.sel].map((control) => (
    ...
    return (
        <div class="w-full h-full text-[#C0E58B] bg-[#404d5a] border-t-4 border-l-4 border-r-4 border-[#BF8DE1]  text-white text-xl flex items-center rounded-t-md">
            ...
            <div class="w-[20%] h-full justify-self-end self-center gap-5 flex flex-row items-center justify-center">
                ...
                class="bg-black w-[20%] h-[50%] border-white border-2 rounded-md items-center justify-center flex overflow-hidden">
    ...
    if (sel >= 0) {
        return (
            <div class="w-full h-full flex flex-col b">
                ...
                <div class="w-full h-full overflow-y-scroll  bg-[#4A5A6A] border-l-4 border-r-4  border-[#657a85] border-b-[#BF8DE1] border-b-4" style={{ width: window.innerWidth * 0.67 }}>
                    <Markdown
                        class=""
