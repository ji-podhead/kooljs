...
##### import
***import them via: `"kooljs/worker_funcions"`***
- for example
```js
import {  hard_reset, reorient_target  } from "kooljs/worker_functions"
```

##### documentation
You can see the docs and the required constructor arguments when hovering over with the mouse, or when entering the args:

![docsstrings](https://github.com/ji-podhead/kooljs/blob/main/callback_doc_strings.png?raw=true)
